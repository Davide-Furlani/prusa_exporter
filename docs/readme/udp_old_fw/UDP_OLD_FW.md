# THIS WAY IS DEPRECATED. I SUPPORT ONLY NEWER FIRMWARES (6.2.2+)
...
Open `Settings`  
![syslog0](images/screenshot_0.jpg)  

Navigate to `Network`  
![syslog1](images/screenshot_1.jpg)  

Find `Metrics & Log`  
![syslog2](images/screenshot_2.jpg)  

Now click on `Allow` - Confirm and change value to `Any Host`. Next switch on `Enabled Stored at Startup`  
![syslog3](images/screenshot_3.jpg)  
![syslog4](images/screenshot_4.jpg)  
![syslog5](images/screenshot_5.jpg)  

Now run your configuration gcode we created before  
![syslog6](images/screenshot_6.jpg)  
![syslog7](images/screenshot_7.jpg)  

Navigate back to `Metrics & Log` and find `Current Configuration` - click on `Metrics Host` and store it as Host   
![syslog8](images/screenshot_8.jpg)  
![syslog9](images/screenshot_9.jpg)  

Click on `Metrics Port` and store it as Metrics Port  
![syslog10](images/screenshot_10.jpg)  
![syslog11](images/screenshot_11.jpg)  
...
![syslog12](images/screenshot_12.jpg)  
